...
export default function LabShell({ children }: { children: React.ReactNode }) {
    ...
    const totalCompleted =
        (arenaStats?.results.filter((r: any) => r.completed).length || 0) +
    ...
    return (
        <div className="min-h-screen md:h-screen flex flex-col md:flex-row w-full relative md:overflow-hidden bg-[#fafafa] dark:bg-[#030303]">
            ...
            <div
                className={`md:hidden w-full h-16 px-4 border-b flex items-center justify-between sticky top-0 z-40 shrink-0 ${
                    mode === "fun"
            ...
            >
                ...
                >
                    ...
                    <div className="relative h-4 overflow-hidden mt-1.5">
                        ...
                        <span
                            className={`absolute top-0 left-0 text-[10px] font-bold tracking-widest uppercase font-mono transition-transform duration-300 translate-y-6 group-hover:translate-y-0 whitespace-nowrap ${
                                mode === "fun"
                                    ? "text-amber-500"
                                    : "text-blue-500"
                            }`}
            ...
            >
                ...
                >
                    ...
                    >
                        <span
                            className={`font-loga text-2xl font-light shrink-0 transition-all ${
                                mode === "fun"
                                    ? "text-zinc-950 dark:text-amber-500 drop-shadow-[0_0_8px_rgba(245,158,11,0.4)]"
                        ...
                        {!isCollapsed && (
                            <div className="relative h-4 overflow-hidden mt-1.5">
                                <span
                                    className={`block text-[10px] font-bold tracking-widest uppercase font-mono transition-transform duration-300 group-hover:-translate-y-6 ${
                                        mode === "fun"
                    ...
                    <div className="mx-3 my-4 p-3 border-2.5 border-black dark:border-amber-500 bg-white/70 dark:bg-zinc-900/50 rounded-xl space-y-2.5 font-mono text-[10px] shadow-[2.5px_2.5px_0px_#000] dark:shadow-[2.5px_2.5px_0px_#f59e0b] animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-center">
                            <div className="bg-stone-50 dark:bg-[#070709] border border-black/10 dark:border-amber-500/10 p-2 rounded-lg">
                                ...
                                <div className="text-[8px] font-black text-stone-500 dark:text-zinc-500 uppercase mt-1 leading-none">
                                    SOLVED
                                </div>
                            </div>
                            <div className="bg-stone-50 dark:bg-[#070709] border border-black/10 dark:border-amber-500/10 p-2 rounded-lg">
                ...
                <div
                    className={`border-t p-2 shrink-0 ${
                        mode === "fun"
                            ? "border-t-3 border-black dark:border-amber-500"
                ...
                <div
                    className={`border-t p-3 shrink-0 space-y-3 ${
                        mode === "fun"
            ...
            {mobileNavOpen && (
                <div
                    className={`fixed inset-0 z-50 flex flex-col p-6 space-y-6 md:hidden overflow-y-auto ${
                        mode === "fun"
                ...
                >
                    <div
                        className={`flex items-center justify-between pb-4 border-b ${
                            mode === "fun"
                                ? "border-b-3 border-black dark:border-amber-500"
                                : "border-zinc-200 dark:border-zinc-900"
                        }`}
                    >
