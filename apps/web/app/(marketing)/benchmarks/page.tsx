        ...
        <div className="lg:w-[65%] w-full space-y-8">
          ...
          <div className="border border-slate-200 dark:border-zinc-900 bg-white dark:bg-[#070709] rounded-lg p-6 shadow-sm dark:shadow-xl space-y-6">
            <div className="flex items-center gap-2 border-b border-slate-200 dark:border-zinc-900 pb-4">
              ...
              <h2 className="text-base font-bold text-zinc-900 dark:text-white">Monorepo Host Benchmarks (Normalizer v0.1.7)</h2>
            </div>
              ...
              <table className="w-full border-collapse text-left font-mono text-[11px] leading-relaxed">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-zinc-800 text-zinc-400 font-bold uppercase tracking-wider">
                    <th className="py-2.5">Text Scale</th>
                    <th className="py-2.5">Avg Length</th>
                    <th className="py-2.5 text-right">JS Latency</th>
                    <th className="py-2.5 text-right text-emerald-500">WASM Latency</th>
                    <th className="py-2.5 text-right">Speedup</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-zinc-900 font-semibold text-zinc-700 dark:text-zinc-300">
                  <tr className="hover:bg-slate-50 dark:hover:bg-zinc-900/10 transition-colors">
                    <td className="py-3 font-sans font-bold">Short Sentences</td>
                    <td className="py-3">~10 chars</td>
                    <td className="py-3 text-right">2.69 μs</td>
                    <td className="py-3 text-right text-emerald-500">3.41 μs</td>
                    <td className="py-3 text-right font-bold text-red-500">0.79x (Slower)</td>
                  </tr>
                  <tr className="hover:bg-slate-50 dark:hover:bg-zinc-900/10 transition-colors">
                    <td className="py-3 font-sans font-bold">Medium Paragraphs</td>
                    <td className="py-3">~150 chars</td>
                    <td className="py-3 text-right">15.73 μs</td>
                    <td className="py-3 text-right text-emerald-500">12.33 μs</td>
                    <td className="py-3 text-right font-bold text-emerald-500">1.28x (Faster)</td>
                  </tr>
                  <tr className="hover:bg-slate-50 dark:hover:bg-zinc-900/10 transition-colors">
                    <td className="py-3 font-sans font-bold">Large Documents</td>
                    <td className="py-3">~1500 chars</td>
                    <td className="py-3 text-right">140.92 μs</td>
                    <td className="py-3 text-right text-emerald-500">136.71 μs</td>
                    <td className="py-3 text-right font-bold text-zinc-400">1.03x (Tied)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            {jsResult && wasmResult ? (
              <div className="space-y-6">
                ...
                <div className="p-4 rounded border border-blue-500/10 bg-blue-500/5 dark:bg-sky-400/[0.02] text-center space-y-1">
                  ...
                  <p className="text-[11px] text-slate-650 dark:text-zinc-450 font-semibold leading-normal">
                    {speedup! > 1 
                      ? `Rust loops mapped your input character-by-character at compile speed.`
