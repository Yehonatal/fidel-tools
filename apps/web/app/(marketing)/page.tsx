    ...
    <main className="flex-grow w-full max-w-7xl mx-auto px-6 py-12 md:py-20 relative z-10">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:w-[50%] space-y-6" data-aos="fade-right">
          ...
          <p className="text-sm sm:text-base font-semibold text-slate-600 dark:text-zinc-400 leading-relaxed max-w-xl font-sans">
            Fully composable, local-first rule stemmers, lexical normalizers, tokenizers, and
            loss-free ASCII transliteration. Powered by a high-performance Rust core with WASM and
            native Python bindings, running up to 35% faster than pure JavaScript implementations.
          </p>
        ...
        <div className="flex-1 w-full" data-aos="fade-left">
          <div className="border border-slate-200 dark:border-zinc-900 rounded-lg overflow-hidden bg-[#0a0a0e] shadow-2xl relative">
            ...
            <div className="bg-[#121218] px-4 py-3 flex items-center justify-between border-b border-[#1b1b24] select-none">
              ...
              >
                {copiedText ? (
                  <span className="text-[9px] font-mono text-emerald-400 font-bold uppercase tracking-wider px-1">
                    Copied!
                  </span>
                ) : (
      ...
      <div className="space-y-6" data-aos="fade-up">
        <div className="text-center space-y-1 max-w-xl mx-auto">
          <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest font-mono block">
            Live Sandbox
          </span>
          ...
          <p className="text-xs font-semibold text-slate-505 dark:text-zinc-400 leading-relaxed font-sans">
            Type custom words or sentences to watch the pipeline execute normalizers, filters, and
            morphological rules.
          </p>
        </div>
        <LandingPlayground />
      ...
      <div className="space-y-8" data-aos="fade-up">
        <div className="max-w-xl space-y-2">
          ...
          <p className="text-xs font-semibold text-slate-500 dark:text-zinc-500 leading-relaxed font-sans">
            Designed with precision for natural language processing of Ethiopic typography,
            character sets, and stemming.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              <div>
                <span className="text-[10px] font-mono text-zinc-500 block mb-3 font-bold">
                  {feat.num}
                </span>
      ...
      <div className="space-y-10" data-aos="fade-up">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-500 leading-relaxed font-sans">
              Traditional NLP libraries are English-centric and fail when applied to Ge'ez-based
              scripts. Fidel Tools introduces a script-first, modular approach designed for maximum
              accuracy and zero overhead.
            </p>
            <div className="p-4 border border-slate-200 dark:border-zinc-900 bg-slate-50/50 dark:bg-zinc-900/10 rounded-xl space-y-2 shadow-sm">
              <span className="text-[10px] font-bold font-mono text-emerald-500 dark:text-emerald-400 uppercase tracking-wider block">
                Targeted Business Value
              </span>
              <p className="text-[11px] font-semibold text-slate-650 dark:text-zinc-400 leading-relaxed font-sans">
                Power accurate search engine indexing (matching{" "}
                <code className="font-mono bg-slate-100 dark:bg-zinc-900 px-1 py-0.5 rounded text-[10px]">
                  ልጆቻቸውን
                </code>{" "}
                to{" "}
                <code className="font-mono bg-slate-100 dark:bg-zinc-900 px-1 py-0.5 rounded text-[10px]">
                ...
                ), reduce LLM token usage in Generative AI / RAG pipelines by stripping Amharic
                stopwords, and run translations offline.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-slate-200 dark:border-zinc-900 p-6 rounded-xl bg-white dark:bg-[#070709] space-y-3">
              ...
              <p className="text-[11px] text-slate-655 dark:text-zinc-400 leading-relaxed font-semibold font-sans">
                In legacy systems, supporting a new regional language requires writing complex
                Python parsing classes. In Fidel Tools, it's just a JSON configuration file.
                Linguists define language specifications without coding, opening up rapid support
                for Tigrinya, Oromo, and Ge'ez.
              </p>
            </div>
            ...
            <div className="border border-slate-200 dark:border-zinc-900 p-6 rounded-xl bg-white dark:bg-[#070709] space-y-3">
              ...
              <p className="text-[11px] text-slate-655 dark:text-zinc-400 leading-relaxed font-semibold font-sans">
                Orthographic ambiguity is the silent killer of Ethiopic text analysis. Fidel Tools
                collapses spelling variations (e.g.{" "}
                <code className="font-mono bg-slate-100 dark:bg-zinc-900 px-1 py-0.5 rounded text-[10px]">
                  ሀ/ሐ/ኀ
                </code>
                ) before tokenization, ensuring downstream search and ML engines read the exact same
                semantic intent.
              </p>
            </div>
            ...
            <div className="border border-slate-200 dark:border-zinc-900 p-6 rounded-xl bg-white dark:bg-[#070709] space-y-3">
              ...
              <p className="text-[11px] text-slate-655 dark:text-zinc-400 leading-relaxed font-semibold font-sans">
                No heavy neural networks or 500MB weights. The core rules engine is under{" "}
                <code className="font-mono">250KB</code>. Run processing locally inside browser
                packages, serverless functions, or edge runtimes with zero API network latency.
              </p>
            </div>
            ...
            <div className="border border-slate-200 dark:border-zinc-900 p-6 rounded-xl bg-[#070709] dark:bg-[#070709] space-y-3">
              ...
              <p className="text-[11px] text-slate-655 dark:text-zinc-400 leading-relaxed font-semibold font-sans">
                Instead of reinventing the wheel, the core engine abstracts script mechanics
                (syllabary, unicode mappings) into a{" "}
                <code className="font-mono bg-slate-100 dark:bg-zinc-900 px-1 py-0.5 rounded text-[10px]">
                  ScriptAdapter
                </code>
                . Multiple regional languages share one adapter, allowing near-instant codebase
                extensibility.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div className="space-y-2">
            ...
            <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400 leading-relaxed max-w-xl font-sans">
              Benchmarks measured on standard medium-length paragraphs (~200 characters) comparing
              JS execution, WebAssembly, and native Python C-extensions.
            </p>
          </div>
          <Link
            href="/benchmarks"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className={getCardClass(jsOps)}>
            ...
            <div className="flex justify-between items-start">
              ...
              <span
                className={`text-xs font-mono ${jsOps === maxOps ? "text-emerald-555" : "text-zinc-500"}`}
              >
                {speedData.medium.js.p50.toFixed(2)} μs
              </span>
            </div>
            <div className="space-y-2">
              <div className={getValueClass(jsOps)}>
                {Math.round(jsOps).toLocaleString()}{" "}
                <span className="text-xs text-zinc-500 font-sans">ops/s</span>
              </div>
              <div className="h-2 rounded-full bg-slate-100 dark:bg-zinc-950 overflow-hidden">
                <div
                  className={`h-full ${getBarColor(jsOps)} rounded-full`}
          ...
          <div className={getCardClass(wasmOps)}>
            ...
            <div className="flex justify-between items-start">
              ...
              <span
                className={`text-xs font-mono ${wasmOps === maxOps ? "text-emerald-555" : "text-zinc-500"}`}
              >
                {speedData.medium.wasm.p50.toFixed(2)} μs
              </span>
            </div>
            <div className="space-y-2">
              <div className={getValueClass(wasmOps)}>
                {Math.round(wasmOps).toLocaleString()}{" "}
                <span className="text-xs text-zinc-500 font-sans">ops/s</span>
              </div>
              <div className="h-2 rounded-full bg-slate-100 dark:bg-zinc-950 overflow-hidden">
                <div
                  className={`h-full ${getBarColor(wasmOps)} rounded-full`}
                  style={{ width: wasmPercent }}
                />
              </div>
            </div>
          </div>
          ...
          <div className={getCardClass(pyOps)}>
            ...
            <div className="flex justify-between items-start">
              ...
              <span
                className={`text-xs font-mono ${pyOps === maxOps ? "text-emerald-555" : "text-zinc-500"}`}
              >
                {pySpeedData.medium.avg.toFixed(2)} μs
              </span>
            </div>
            <div className="space-y-2">
              <div className={getValueClass(pyOps)}>
                {Math.round(pyOps).toLocaleString()}{" "}
                <span className="text-xs text-zinc-500 font-sans">ops/s</span>
              </div>
              <div className="h-2 rounded-full bg-slate-105 dark:bg-zinc-950 overflow-hidden">
                <div
                  className={`h-full ${getBarColor(pyOps)} rounded-full`}
